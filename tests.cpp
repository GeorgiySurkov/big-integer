...
TEST(correctness, shr_long)
{
    ...
    EXPECT_EQ(BigInteger("-795781654945163027062813919774445792779524912482"),
              BigInteger("-3417856182746231874623148723164812376512852437523846123876") >> 32);

    EXPECT_EQ(BigInteger("-397890827472581513531406959887222896389762456241"),
              BigInteger("-3417856182746231874623148723164812376512852437523846123876") >> 33);
}
